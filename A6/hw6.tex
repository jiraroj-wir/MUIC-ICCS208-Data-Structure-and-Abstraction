...
\begin{enumerate}[label=(\roman*)]
    ...
    \item we know for a fact that

        \[g(n) \le 2(1 + \ln{n+1})\]

        so from $g(n) = \frac{f(n)}{n+1} \Rightarrow f(n) = (n+1)\cdot g(n)$

        \begin{align*}
            f(n) &\le 2(n+1)(1 + \ln{n+1}) \\
            &\le 2n + 2n\ln{n+1} + 2 + 2\ln{n+1}
        \end{align*}

        which, 

        \[\lim_{n\rightarrow\infty} \frac{f(n)}{n\ln{n}} = \lim{n\rightarrow\infty} \frac{2n + 2n\ln{n+1} + 2 + 2\ln{n+1}}{n\ln{n}} = 2\]

        the limit of the two is a constant of 2, therefore

        \[\boxed{f(n) \in \Theta(n\ln{n})}\]
\end{enumerate}
